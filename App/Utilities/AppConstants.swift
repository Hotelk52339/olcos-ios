...
enum AppConstants {
    ...
    /// In-app update checker (#360). Endpoints use the olcOS release repository,
    /// matching `${GITHUB_REPOSITORY}` where the release workflow publishes.
    enum Update {
        ...
        static let repoSlug = "Hotelk52339/olcos-ios"

        /// Unsigned-IPA asset name attached to every release (release.yml).
        static let ipaAssetName = "olcos-ios-unsigned.ipa"
