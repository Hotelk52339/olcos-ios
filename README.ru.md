<div align="center">
  ...
  <p><strong>1.0</strong> · сборка <strong>1</strong> · тег выпуска <code>v1.0.1</code></p>
  <p>
...
<div align="center">
  ...
  <p><sub>Концептуальное превью интерфейса — иллюстрация, не нативный скриншот и не подтверждение запуска в Xcode.</sub></p>
</div>
...
| **Спокойный интерфейс** | Русский, английский и французский; тактильный отклик на действия; декоративная волна движется только при активном, видимом подключении и учитывает настройку уменьшения движения. Это **не график трафика и не измерение скорости**. [Локализация](App/Localization/L10n.swift) · [волна и тактильный отклик](App/Views/SignalWaveform.swift). |
